            ...
            <div class="huruma-responsive-nav">
                <div class="container">
                    <div class="huruma-responsive-menu">
                        <div class="logo">
                            <a href="index.html">
                               <!-- <img src="assets/img/logo.jpg" class="white-logo" alt="logo">
                            ...
                            <div class="others-options">
                                <div class="dropdown language-switcher d-inline-block">
                                   <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img src="assets/img/flag/ug.jpg" class="shadow" alt="image">
                                        <span>UG</span>
                                    </button>
                        ...
                        <div class="single-footer-widget">
                            ...
                            <div class="footer-news">
                               <a href="single-blog.html">
                                    <img src="assets/img/footer-news/pic1.jpg" alt="image">
                          ...
                          <div class="footer-news">
                               <a href="single-blog.html">
                                    <img src="assets/img/footer-news/pic2.jpg" alt="image">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-4">
                                <div class="copyright-logo">
                                    <!--<img src="assets/img/white-log.png" alt="image" width="80px"> -->
                                </div>
                            </div>
